...
proportion_in_20th_century = imdb.where('Year', are.below(2000)).num_rows / 250
proportion_in_21st_century = imdb.where('Year', are.above_or_equal_to(2000)).num_rows / 250
...
year_remainder = imdb.with_column('Year Remainder', imdb.column('Year')%2)
num_even_year_movies = year_remainder.where('Year Remainder', are.equal_to(0)).num_rows
